...
Annotations applying to fields should be listed __on the seperate lines__, and must be listed smallest to largest in terms of character length of annotation.
